...
/* ----- AJAX request handlers ----- */
	...
	function enqueue_editor_scripts() {
		...
		wp_localize_script('wdsm_editor', 'l10nWdsm', array(
			...
			'add_ad' => __('Social Ad einfügen', 'wdsm'),
			...
			'add_blank' => __('Füge einen leeren Platzhalter für eine Anzeige ein', 'wdsm'),
			'or_select_below' => __('oder wähle eine Anzeige zum Einfügen aus den unten aufgeführten aus', 'wdsm'),
			'dflt' => __('Standard', 'wdsm'),
			'ad_class' => __('Zusätzliche CSS-Klassen (Link)', 'wdsm'),
			'ad_container_class' => __('Zusätzliche CSS-Klassen (Container)', 'wdsm'),
	...
	function media_buttons( $editor_id = 'content' ) {
		...
		printf( '<a href="#TB_inline?width=480&amp;inlineId=wdsm_ad_container&amp;width=753&amp;height=48" onclick="return wdsm_openEditor();" id="add_advert" class="button thickbox" data-editor="%s" title="%s">
			...
			esc_attr( $editor_id ),
			esc_attr__('Social Ad einfügen', 'wdsm'),
			__('Social Ad einfügen', 'wdsm')
		);
